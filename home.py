...
"""
    ...
    st.markdown('<h2 id="government-hr-sec-school-government-was-established-in-1950-and-it-is-managed-by-the-state-government" style="color: green;">Government HR.SEC.SCHOOL, Government was established in 1950 and it is managed by the state government.</h2>',unsafe_allow_html=True)
